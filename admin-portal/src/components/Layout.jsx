    ...
    <div className="flex h-screen overflow-hidden bg-background font-sans">
      ...
      `}>
        ...
        <Link 
          ...
          className="block p-6 border-b border-border bg-muted/30 hover:bg-muted/50 transition-colors group cursor-pointer"
        >
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary font-semibold text-lg uppercase group-hover:scale-105 transition-transform">
              {profile?.full_name?.charAt(0) || 'U'}
            </div>
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-semibold text-foreground group-hover:text-primary transition-colors">{profile?.full_name}</p>
